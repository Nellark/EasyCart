...
import { HttpClient, HttpClientModule } from '@angular/common/http';  // Make sure to import HttpClientModule
...
@Component({
  selector: 'app-home',
  standalone: true,
  imports: [CommonModule, NgFor, RouterLink, HttpClientModule, NavbarComponent],  // Include HttpClientModule here
  ...
  ngOnInit(): void {
    this.productService.getAllProducts().subscribe(
      (serverData: ProductsResponseInterface) => {
        console.log('Fetched products:', serverData);
